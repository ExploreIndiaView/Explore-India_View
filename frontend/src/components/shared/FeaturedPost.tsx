...
export default function LatestPosts() {
  return (
    <section className="py-16 bg-white text-left">
      <h3 className="text-3xl font-semibold text-center text-gray-900 mb-10">Latest Posts</h3>
